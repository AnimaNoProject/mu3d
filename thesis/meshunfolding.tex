...
\section{Results}
The algorithm yields good results for models with a lower amount of triangles, where unfoldings can be found fast. The unfolding time can vary for each model due to the random walk in the simulated annealing process. For bigger models like seen in Figure ??, take more time to unfold and depending of the maximum number of iterations unfoldings might not be found.
Figure \ref{fig:tiger} to Figure Last show some examples of resulting unfoldings that have been achieved. The models have different number of triangles, more detail can be found in section \ref{sec:performance} regarding the exact number of faces and the time it takes for each unfolding.
...
\begin{figure}
  ...
  \caption{3D Model of a tiger head and its unfolding.}
  \label{fig:tiger}
\end{figure}
...
\begin{figure}
  ...
  \caption{3D Model and its unfolding.}
  \label{fig:sqrt3}
\end{figure}
...
\begin{figure}
  ...
  \caption{3D Model of a star-like object and its unfolding.}
  \label{fig:pnsplit}
\end{figure}
...
\begin{figure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{"graphics/unfoldings/model_star"}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{"graphics/unfoldings/unfold_star"}
  \end{subfigure}
  
  \caption{3D Model of a star and its unfolding.}
  \label{fig:star}
\end{figure}
